...
"""
Module defines a class LRUCache that inherits from BaseCaching and
is a caching system
"""
...
class LRUCache(BaseCaching):
    """
    inherits from BaseCaching and is LRU a caching system
    """
        ...
        if key and item:
            if len(self.cache_data.keys()) < self.MAX_ITEMS:
                ...
                if key in self.cache_data.keys():
                    ...
                    discarded_key = self.recency_bit.pop(0)
